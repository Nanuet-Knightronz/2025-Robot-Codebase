...
public class RobotContainer {
    ...
    // private final Trigger forwardHold = new Trigger(() -> Math.abs(driver.getRawAxis(4)) < 0.2);
    // private final Trigger backwardHold = new Trigger(() -> Math.abs(driver.getRawAxis(4)) < -0.2);
